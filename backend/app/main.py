...
from routes import devices, energy, prediction, anomalies, user_routes, analytics, zones, faults, behavioral_profiles, chatbot as chatbot_routes, dashboard
...
app.include_router(behavioral_profiles.router)
